// Developed by Joseph Zachary. 
// Modified by Snehashish Mishra, u0946268 on 8th March for
// CS 3500 offered by The University of Utah.
//
// Modification: Color of the spreadsheet grid.
...
namespace SSGui
{
    ...
    public partial class SpreadsheetDemo : Form
    {
        ...
        public SpreadsheetDemo()
        {
            ...
            // an event happens.  
            // So we register the displaySelection method below.
        ...
        private void displaySelection(SpreadsheetPanel ss)
        {
            ...
            else  // if the selected cell is already set, reset it
            {
                ss.SetValue(col, row, DateTime.Now.ToLocalTime().ToString("T"));
                ss.GetValue(col, row, out value);
                MessageBox.Show("Selection: column " + col + " row " + row + " value " + value);
